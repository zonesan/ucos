...
struct g72x_state {
#if 0  // for version 4
	long yl_L;	/* Locked or steady state step size multiplier. */
	long yu_L;	/* Unlocked or non-steady state step size multiplier. */
	long dms_L;	/* Short term energy estimate. */
	long dml_L;	/* Long term energy estimate. */
#else  // for version 1
	...
	short pk[2];	// NIUD added, 11/15/2005
