...
#include "def_type.h"
#include "Slic.h"
//#define sleep(delay)	OSTimeDlyHMSM(0, 0, 0, delay);

//LONG calibratePrecisionClock(VOID);
...
//ULONG delay( unsigned long wait);
...
LONG sendProSLICID(ULONG channelid);
...
BYTE Interrupt(ULONG channelid);
...
VOID writeDirectReg(BYTE address, BYTE data,ULONG channelid);
BYTE readDirectReg(BYTE address,ULONG channelid);
VOID writeIndirectReg(BYTE address, WORD data,ULONG channelid);
WORD readIndirectReg(BYTE address,ULONG channelid);
...
VOID byteToSpi (BYTE byte,unsigned int cs );
BYTE  spiToByte(unsigned int );
//VOID reInit (VOID );
BYTE  Interrupt(ULONG channelid );
//LONG readTSC (VOID);
//LONG calibratePrecisionClock(VOID);
...
typedef struct {
	...
	union {
	WORD onTime;
	struct	{BYTE onLowByte;BYTE onHiByte;};

		};

	union {
	WORD offTime;
	struct	{BYTE offLowByte;BYTE offHiByte;};
			};
...
extern BYTE chipSelectByte[];
extern BYTE currentChip, numberOfChips;
...
#define	RINGBACKJAPANTONE_IR13	0X79C0	
#define	RINGBACKJAPANTONE_IR14	0xe9	
#define	RINGBACKJAPANTONE_IR16	0x7940	
#define	RINGBACKJAPANTONE_IR17	0xf2	
...
#define	BUSYJAPANTONE_IR13	0x79c0	
#define	BUSYJAPANTONE_IR14	0x00e9	
#define	BUSYJAPANTONE_IR16	0
#define	BUSYJAPANTONE_IR17	0	
...
#define	STANDARD_CAL_DR97	0x18//stone debug//0x18	//	Calibrations without the ADC and DAC offset and without common mode calibration.
...
#define	RESET_VALUE_DR8	2	//	This is the value at HwSlicGpioReset of DR8
#define	RESET_VALUE_DR64	0	//	This is the value at HwSlicGpioReset of DR64
#define	RESET_VALUE_DR11	0x33	//	This is the value at HwSlicGpioReset of DR11				
...
#define	INIT_IR4		0x2222	//	DTMF_ROW3_PEAK(0x3333)		sovle TCL telephone problem	
...
#define	INIT_IR11		0x019C	//	DTMF_COL_2ND_ARM,	//0xE5 stone debug for key detect  07/05/21
...
#define	INIT_IR31		0x0080	//	COMMON_MIN_TRES,	
#define	INIT_IR32		0xd28  	//	COMMON_MAX_TRES,	0x7c0	revised 061116
#define	INIT_IR33		0x376f	//	PWR_ALARM_Q1Q2,	
...
#define	INIT_IR38		0x08c	//	TERM_LP_POLE_Q1Q2,	
#define	INIT_IR39		0x010	//	TERM_LP_POLE_Q3Q4,	
#define	INIT_IR40		0x0200	//	TERM_LP_POLE_Q5Q6,	
#define	INIT_IR41		0x0600	//	CM_BIAS_RINGING,	 for 6V	1.5V/lsb 	stone debug,orig = 0xc00
...
#define STARDARD_IR_INIT_ARRAY  WORD ir[] =\
{\
\
INIT_IR0	,\
INIT_IR1	,\
...
#define	INIT_DR1	0X00	//	PCM Mode	0x28
...
#define	INIT_DR15	0x2e	//	Initialization Powerdown Control 2	//debug orig 0x0
...
#define	INIT_DR71	0X1	//	71 0x47 0x00 0x01 Initialization Off-Hook Loop Current Limit (20 mA + 3 mA/LSB)
#define	INIT_DR72	0X1E	//	72 0x48 0x20 Initialization On-Hook Voltage (open circuit voltage) = 48 V(1.5 V/LSB)
#define	INIT_DR73	0X02	//	73 0x49 0x02 Initialization Common Mode Voltage뾙CM = ? V(?.5 V/LSB)
#define	INIT_DR74	0X2D	// for -68V	//	74 0x4A 0x32 Initialization VBATH (ringing) = ?5 V (?.5 V/LSB)
#define	INIT_DR75	0X10	//	75 0x4B 0x10 Initialization VBATL (off-hook) = ?4 V (TRACK = 0)(?.5 V/LSB)
#define	INIT_DR92	0xcc	//	92 0x5C  7F Initialization DC뺻C Converter PWM Period (61.035 ns/LSB)
#define	INIT_DR93	0x34	//	93 0x5D 0x14 0x19 Initialization DC뺻C Converter Min. Off Time (61.035 ns/LSB)
#define	INIT_DR94	0x2c	//	94 stone add for debug
...
#define SIF_UCOS_TO_LINUX_CNT 5
#define SIF_LINUX_TO_UCOS_CNT 6
