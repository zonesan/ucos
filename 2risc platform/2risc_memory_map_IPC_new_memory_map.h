...
#define ETHERNET_B_ADDR		0x1fb6000 
#define ETHERNET_E_ADDR		0x2000000// 300K
#define ETHERNET1_B_ADDR		BOOTLOADER_B_ADDR
#define ETHERNET1_E_ADDR		BOOTLOADER_E_ADDR


/*
#define AUDIO_OUT_CH0_ADDR   AUDIO_B_ADDR
#define AUDIO_OUT_CH0_LEN    0x10000   

#define AUDIO_IN_CH0_ADDR   (AUDIO_OUT_CH0_ADDR + AUDIO_OUT_CH0_LEN)
#define AUDIO_IN_CH0_LEN    0x4000  
*/
...
//extern unsigned int gMpeg4EncodeReconAndVideoShareBuffer[(MPEG_ENCODE_RECON_BUFSIZE + VIDEO_MAX_DATABUF_SIZE) / sizeof(int)];
...
#define MOTION_MAX_DATABUF_SIZE 0x1E000  //120k
...
#define AUDIO_MAX_PCMBUF_SIZE  0x800
