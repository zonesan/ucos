...
#define UCOS_E_ADDR		0x450000     //2M
#define LINUX_B_ADDR		0x450000      
#define LINUX_E_ADDR		0xdb0000
#define ROMFS_B_ADDR		0xdb0000 
#define ROMFS_E_ADDR		0x1000000    //2368K
#define ETHERNET_B_ADDR		0x1000000
#define ETHERNET_E_ADDR		0x1000000 //0K
#define CPU_SHARE_B_ADDR		BOOTLOADER_B_ADDR
#define CPU_SHARE_E_ADDR		0xa1000
#define Q_B_ADDR			0xa1000   //48k
#define Q_E_ADDR			0xb0000	
#define ETHERNET1_B_ADDR		0xb0000
#define ETHERNET1_E_ADDR		BOOTLOADER_E_ADDR //64*5K
#define ETH_BLOCK_64K_NUM		5	

#define AUDIO_MAX_FRAME_LEN	0
#define AUDIO_MAX_FRAME_NUM	0
#define AUDIO_MAX_DATABUF_SIZE  0
#define AUDIO_MAX_PARABUF_SIZE	0x0
...
#define SLIC_MAX_DATABUF_SIZE	0x0
...
#define VIDEO_MAX_PARABUF_SIZE	0x80
...
#define VIDEO_LINUX_TO_UCOS_E_ADDR	(VIDEO_LINUX_TO_UCOS_B_ADDR+0x0)
#define VIDEO_PARA_B_ADDR  	VIDEO_LINUX_TO_UCOS_E_ADDR
#define VIDEO_PARA_E_ADDR  	(VIDEO_PARA_B_ADDR+VIDEO_MAX_PARABUF_SIZE)
#define VIDEO_START_PARA_B_ADDR 	VIDEO_PARA_E_ADDR 
#define VIDEO_START_PARA_E_ADDR  	(VIDEO_START_PARA_B_ADDR+VIDEO_MAX_PARABUF_SIZE)
...
#define MOTION_MAX_DATABUF_SIZE 0x0
#define MOTION_UCOS_TO_LINUX_B_ADDR   VIDEO_START_PARA_E_ADDR
#define MOTION_UCOS_TO_LINUX_E_ADDR	(MOTION_UCOS_TO_LINUX_B_ADDR+MOTION_MAX_DATABUF_SIZE)
#define MOTION_UCOS_TO_LINUX_CNT	4

/* gb added on Sept. 13 to fit RiscChgCnt, 2007 */
#define DVR_MAX_BITMAPBUF_SIZE 0x80000
#define DVR_MAX_STRINGBUF_SIZE 0x100
#define DVR_AREA_VECTOR_SIZE 0x18 //24bytes
#define DVR_MAX_COLORBUF_SIZE  0x104
#define DVR_LINUX_TO_UCOS_BITMAPBUF_B_ADDR  MOTION_UCOS_TO_LINUX_E_ADDR
#define DVR_LINUX_TO_UCOS_BITMAPBUF_E_ADDR  (DVR_LINUX_TO_UCOS_BITMAPBUF_B_ADDR+DVR_MAX_BITMAPBUF_SIZE)
#define DVR_LINUX_TO_UCOS_STRINGBUF_B_ADDR DVR_LINUX_TO_UCOS_BITMAPBUF_E_ADDR
#define DVR_LINUX_TO_UCOS_STRINGBUF_E_ADDR (DVR_LINUX_TO_UCOS_STRINGBUF_B_ADDR+DVR_MAX_STRINGBUF_SIZE)
#define DVR_LINUX_TO_UCOS_AREAVECTOR_B_ADDR DVR_LINUX_TO_UCOS_STRINGBUF_E_ADDR
#define DVR_LINUX_TO_UCOS_AREAVECTOR_E_ADDR (DVR_LINUX_TO_UCOS_AREAVECTOR_B_ADDR+DVR_AREA_VECTOR_SIZE)
#define DVR_LINUX_TO_UCOS_COLORBUF_B_ADDR DVR_LINUX_TO_UCOS_AREAVECTOR_E_ADDR
#define DVR_LINUX_TO_UCOS_COLORBUF_E_ADDR (DVR_LINUX_TO_UCOS_COLORBUF_B_ADDR+DVR_MAX_COLORBUF_SIZE)

#define COMM_MAX_COUNTBUF_SIZE 0x500  //5 * 0x100
#define COMM_COUNTBUF_B_ADDR	   DVR_LINUX_TO_UCOS_COLORBUF_E_ADDR
#define COMM_COUNTBUF_E_ADDR	   (COMM_COUNTBUF_B_ADDR+COMM_MAX_COUNTBUF_SIZE)
#define COMM_SEMAPHORE		0x1
/* gb added on Sept. 13 to fit RiscChgCnt, 2007 */

#define AUDIO_MAX_PCMBUF_SIZE  0x0
#define AUDIO_LINUX_TO_UCOS_PCMBUF_B_ADDR MOTION_UCOS_TO_LINUX_E_ADDR
#define AUDIO_LINUX_TO_UCOS_PCMBUF_E_ADDR (AUDIO_LINUX_TO_UCOS_PCMBUF_B_ADDR+AUDIO_MAX_PCMBUF_SIZE)
/**********************************************************************************/
